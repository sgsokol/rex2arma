...
# The original R code was modified in 3 places before submission to rex2arma():
...
balancing=TRUE
cppp_code=rex2arma(expm.higham, fname="expm_cpp", exec=0, rebuild=TRUE, copy=FALSE)
