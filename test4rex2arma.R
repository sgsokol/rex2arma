...
# usage:
# > x=rnorm(3); c1 = 4.5; c2 = 3; consistency = "TRUE"; mu.too = TRUE; b=c2*qnorm(3/4); mu_too=mu.too
# > code=rex2arma(scaleTau2, exec=1); cat(code) 
# > scaleTau2_arma_(x, c1, c2, consistency, mu_too)
